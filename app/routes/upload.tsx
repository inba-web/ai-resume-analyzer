...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        ...
        let uploadedFile: any = await fs.upload([file]);
        ...
        let uploadedImage: any = await fs.upload([imageFile.file]);
        if (Array.isArray(uploadedImage)) uploadedImage = uploadedImage[0];
